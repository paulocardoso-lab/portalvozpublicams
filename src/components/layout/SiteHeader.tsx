      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center px-[28px] py-[18px] gap-[20px]">
        ...
        <div className="flex gap-[12px] justify-end items-center font-sans text-[11px] text-vp-text-3">
          ...
          {[
            ...
            <a key={s.k} href={s.url} target="_blank" rel="noopener noreferrer" className="w-[24px] h-[24px] border border-vp-border-2 rounded-[2px] inline-flex items-center justify-center text-[9px] font-bold text-vp-text-2 hover:border-vp-accent hover:text-vp-accent transition-all">
              {s.k}
            </a>
          ))}
        </div>
