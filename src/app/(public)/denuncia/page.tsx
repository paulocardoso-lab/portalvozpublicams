...
export default function DenunciaPage() {
  return (
    <main className="max-w-[800px] mx-auto px-6 py-12">
      <div className="mb-12">
        <h1 className="font-display text-[48px] leading-[0.95] mb-6 tracking-tighter">
          Sua voz é a nossa <span className="italic text-vp-accent">arma.</span>
        </h1>
        <p className="text-vp-text-2 text-[18px] leading-relaxed">
      ...
      <div className="mt-12 grid md:grid-cols-2 gap-8 text-[14px] text-vp-text-3">
